...
#modified move
defend = Move(name="Defend", type="Normal", value= 50)
...
rowlet_moveset = [tackle, defend, leafage, tackle]
...
litten_moveset = [scratch, defend, ember, lick]
...
popplio_moveset = [pound, defend, water_gun, disarming_voice]
